...
public class Redisalert extends Command {
	...
	public static void executeAlertCommand(CommandSender sender, String[] args){
		...
		if (args.length >= 1) {
			...
			BungeeUtilisals.getInstance().getRedisManager().getRedis().sendChannelMessage(ChannelNames.BU_CHAT.toString(), prefix + msg);
		} else {
